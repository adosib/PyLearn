...
def check_bullet_alien_collisions(ai_settings, screen, ship, aliens, bullets):
    ...
    # If there are, remove bullet and alien
...
def check_alien_landing(ai_settings, stats, screen, ship, aliens, bullets):
...
def update_aliens(ai_settings, stats, screen, ship, aliens, bullets):
    ...
    if pygame.sprite.spritecollideany(ship, aliens):
        ship_hit(ai_settings, stats, screen, ship, aliens, bullets)
    # Look for laiens hitting the bottom of the screen
    check_alien_landing(ai_settings, stats, screen, ship, aliens, bullets)